          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  coustmContainerMoreScreen(
                      padding: 6.0,
                      width: 155,
                      height: 180,
                      Color: Color.fromARGB(157, 182, 92, 224),
                      child: Center(
                        child: Column(
                          children: [
                            CircleAvatar(
                              backgroundImage:
                                  AssetImage('assets/images/net.jpg'),
                            ),
                            ///////////////////
                ...
                child: Center(
                  child: Column(
                    children: [
                      ...
                      coustmRowMoreScrren(
                          text1: " you",
                          image1: 'assets/images/uou.jpg',
                          text2: "يمن مبايل",
                          image2: 'assets/images/ymn.jpg'),
                      const Divider(
                        height: 20,
                      ),
                      coustmRowMoreScrren(
                          text1: " واي",
                          image1: 'assets/images/way.jpg',
                          text2: " سبافون",
                          image2: 'assets/images/sbafon.jpg'),
                      const Divider(
                        height: 20,
                      ),
                      coustmRowMoreScrren(
                          text1: " App store",
                          image1: 'assets/images/abl.jpg',
                          text2: " Google play",
                          image2: 'assets/images/blay.jpg'),
                    ],
                  ),
                ),
              ),
              ...
              coustmContainerMoreScreen(
                ...
                width: 370,
                height: 310,
                Color: Color.fromARGB(197, 241, 37, 37),
                child: Column(
                  children: [
                    Container(
                    ...
                    coustmContainerMoreScreen(
                        ...
                        height: 70,
                        Color: Colors.white,
                        child: coustmColumnMoreScrren(
                            Text1: "متجر الكتروني متكامل",
                            icon: Icons.shopping_cart,
                            Text2:
                                'يمكنك تصفح المنتجات المعروضة للبيع من قبل الاداره'
              ...
              Container(
                margin: const EdgeInsets.only(
                    top: 20, left: 15, right: 15, bottom: 4),
                width: 350,
                height: 300,
                ...
                child: Column(
                  children: [
                    ...
                    coustmContainerMoreScreen2(
                        ...
                        Text2:
                            'نقدم بشكل دوري مسابقات اسئلة او توقعات وحصول علي جوائز',
                    ...
                    coustmContainerMoreScreen2(
                        ...
                        icon1: Icons.navigate_before,
                        Text2:
                            'يمكن اضافة رقم يمن موبايل او الانترنت والهاتف الثابت بتسديدها',
                    ...
                    coustmContainerMoreScreen2(
                        ...
                        icon1: Icons.navigate_before,
                        Text2:
                            'يمكنك تغذية حسابك بنفسك عبر البنوك والمحافظ الالكترونيه ',
